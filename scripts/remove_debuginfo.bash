...
# For arm64 JVMCI is always included when applicable
...
for dir in jdk jre; do
    cp -v ${FREETYPE_DIR}/lib/libfreetype.so images/${dir}/lib/ || true
    cp -v ${DEPS_LIB_DIR}/libawt_xawt.so images/${dir}/lib/ || true
    cp -v ${DEPS_LIB_DIR}/libnuma.so images/${dir}/lib/ || true
    cp -rv ${CURRENT_DIR}/fonts_config/* images/${dir}/lib/ || true
